...
play.init = function () {
	...
	// set position to piece and setToShow
...
play.clickCanvas = function (e) {
	...
	// get clicked piece and coordinate 
...
// if clicked a key, what to do
play.clickMan = function (key, x, y) {
	var man = com.mans[key];
	// if another_key_selected and not_same_with_new_key and not_same_side_
	// phrase 2 of moving
	if (play.nowManKey && play.nowManKey != key && man.my != com.mans[play.nowManKey].my) {
		// if xy is possible move
...
play.clickPoint = function (x, y) {
	...
	var man = com.mans[key];
	// if there is a selected piece, make a move 
	if (play.nowManKey) {
...
// check if xy is in ps(possible moves)
...
// get click coordinate on canvans (8x9)
...
// use canvas coordiante and map to get piece 
